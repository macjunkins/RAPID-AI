...
# RAPID-AI Knowledge Base

## Overview

RAPID-METHOD™ (Breakthrough Method of Agile AI-driven Development) is a framework that combines AI agents with Agile development methodologies. The v4 system introduces a modular architecture with improved dependency management, bundle optimization, and support for both web and IDE environments.
...
RAPID transforms you into a "Vibe CEO" - directing a team of specialized AI agents through structured workflows. Here's how:
...
- `src/rapid/` folder created with all agents
- IDE-specific integration files created
- All agent commands/rules/modes available

**Remember**: At its core, RAPID-METHOD™ is about mastering and harnessing prompt engineering. Any IDE with AI agent support can use RAPID - the framework provides the structured prompts and workflows that make AI development effective
...
## Core Configuration (rapid-config.yaml)

**New in V4**: The `src/rapid/rapid-config.yaml` file is a critical innovation that enables RAPID to work seamlessly with any project structure, providing maximum flexibility and backwards compatibility.

### What is rapid-config.yaml?

This configuration file acts as a map for RAPID agents, telling them exactly where to find your project documents and how they're structured. It enables:
...
3. **Custom Workflows**: Configure RAPID to match your team's process
...
- **Checklists** (`src/rapid/checklists/`): Quality assurance checklists for validation and review
- **Data** (`src/rapid/data/`): Core knowledge base and technical preferences
...
RAPID employs a sophisticated template system with three key components:

1. **Template Format** (`utils/rapid-doc-template.md`): Defines markup language for variable substitution and AI processing directives from yaml templates
...
This architecture enables seamless operation across environments while maintaining the rich, interconnected agent ecosystem that makes RAPID powerful.
...
Expansion packs extend RAPID-METHOD™ beyond traditional software development into ANY domain. They provide specialized agent teams, templates, and workflows while keeping the core framework lean and focused on development.
